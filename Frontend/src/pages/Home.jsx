...
const categoriesData = [
  ...
  },
  {
    id: 2,
    name: 'Women',
    image: 'https://images.unsplash.com/photo-1494790108755-2616c39a9e23?w=400&h=500&fit=crop',
    count: '3.2K+ Pieces',
...
const AnimatedElement = ({ children, delay = 0, animation = 'fadeInUp' }) => {
  ...
  const animations = {
    ...
    fadeInLeft: hasAnimated ? 'animate-fade-in-left' : 'opacity-0 -translate-x-8',
    fadeInRight: hasAnimated ? 'animate-fade-in-right' : 'opacity-0 translate-x-8',
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <AnimatedElement delay={300}>
        <div className="relative group">
          <div className={`relative overflow-hidden rounded-2xl bg-white border-2 transition-all duration-300 ${
            isFocused ? 'border-black shadow-2xl' : 'border-gray-200 shadow-lg'
          }`}>
      ...
      <div className="relative h-96 md:h-[500px] rounded-3xl overflow-hidden shadow-2xl group">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-start p-8 md:p-16">
          ...
          <AnimatedElement delay={1100}>
            <button className="group relative px-8 py-4 border-2 border-white text-white font-semibold rounded-full overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
      ...
      <AnimatedElement delay={200}>
        <div className="bg-black rounded-3xl p-8 md:p-16 text-center">
          ...
          <p 
            ...
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
            Be the first to know about our latest drops, exclusive offers, and style insights. 
            No spam, just pure fashion goodness.
          </p>
